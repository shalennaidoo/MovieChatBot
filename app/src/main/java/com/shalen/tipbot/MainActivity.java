...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final LanguageConfig config = new LanguageConfig("ja", "ff89e9f90e1b479d8ec0c45073a37c72");
        initService(config);
    }
    ...
    private void initChatView() {
        ...
        String myName = "Shalen";
        myAccount = new User(myId, myName, icon);

        int botId = 1;
        String botName = "AndroidBot";
        droidKaigiBot = new User(botId, botName, icon);

        chatView = findViewById(R.id.chat_view);
        chatView.setRightBubbleColor(getResources().getColor(R.color.rightbubblecolor));
        chatView.setLeftBubbleColor(getResources().getColor(R.color.leftbubblecolor));
        chatView.setBackgroundColor(getResources().getColor(R.color.bgcolor));
        ...
        chatView.setInputTextHint("Enter a message...");
